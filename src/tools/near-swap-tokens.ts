...
export const nearSwapTokensTool = {
	...
	description:
		"Get a list of tokens currently supported by the 1Click API for NEAR intent swaps. Returns token metadata including blockchain, contract address, current USD price, symbol, decimals, and price update timestamp for each supported asset.",
